...
const translations = {
  "en": {
    ...
    "case_homelab_status": "Current status: public repository with a reproducible LITE/FULL Docker foundation; tools remain candidates until installation and validation exercises are recorded.",
  ...
  "es": {
    ...
    "case_homelab_status": "Estado actual: repositorio público con una base Docker reproducible LITE/FULL; las herramientas siguen siendo candidatas hasta documentar ejercicios de instalación y validación.",
  ...
  "ca": {
    ...
    "case_homelab_status": "Estat actual: repositori públic amb una base Docker reproduïble LITE/FULL; les eines continuen sent candidates fins que es documentin exercicis d’instal·lació i validació.",
