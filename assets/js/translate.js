...
const translations = {
  "en": {
    ...
    "show_more": "Show more",
    "show_less": "Show less",
    "hero_eyebrow": "Junior SOC Analyst / Blue Team candidate · Menorca · Remote across Spain / EU",
    "hero_statement": "I turn daily learning into auditable defensive proof of work. I build small, inspectable security systems that show how I think: source-backed triage, Linux and container operations, network visibility, documentation, recovery and careful automation.",
    ...
    "projects_intro": "Start here for interview evidence. These case studies explain what was built, why it matters defensively and where public source or lab notes are available.",
    "email": "Email",
    "location": "Location",
    "location_value": "Menorca, Balearic Islands, Spain",
    "resume": "Resume",
    "openpdf": "Open PDF",
    "certifications": "Certifications",
    "contact_1": "For junior SOC / Blue Team opportunities, email me:",
    "contact_2": "You can also review my <a href='https://github.com/JimBLogic' target='_blank' rel='noopener noreferrer'>GitHub</a>, <a href='./assets/pdfs/Jaime Ramsden de Frutos CV.pdf' target='_blank' rel='noopener noreferrer'>CV</a> or <a href='https://www.linkedin.com/in/jimblogic/' target='_blank' rel='noopener noreferrer'>LinkedIn</a>.",
    ...
    "proof_path_eyebrow": "Recruiter route",
    "proof_path_title": "A 60-second proof path",
    "proof_path_intro": "Start with what I built, inspect how I explain decisions, then verify the training behind it.",
    "proof_path_1_title": "See the output",
    "proof_path_1_desc": "Open today's defensive intelligence brief.",
    "proof_path_2_title": "Inspect the system",
    "proof_path_2_desc": "Review the automation and validation.",
    "proof_path_3_title": "Follow the build",
    "proof_path_3_desc": "Explore the defensive homelab baseline.",
    "proof_path_4_title": "Verify foundations",
    "proof_path_4_desc": "Check selected certificates and labs."
  },
  "es": {
    "main_name": "Jaime Ramsden de Frutos",
    ...
    "show_more": "Ver más",
    "show_less": "Ver menos",
    "hero_eyebrow": "Candidato a Analista SOC Junior / Blue Team · Menorca · Remoto en España / UE",
    "hero_statement": "Convierto el aprendizaje diario en evidencia defensiva auditable. Construyo sistemas de seguridad pequeños e inspeccionables que muestran cómo pienso: triaje basado en fuentes, operaciones Linux y contenedores, visibilidad de red, documentación, recuperación y automatización cuidadosa.",
    ...
    "projects_intro": "Empieza aquí para ver evidencia útil en una entrevista. Estos casos explican qué se construyó, por qué es relevante para la defensa y dónde hay código o notas públicas disponibles.",
    "email": "Correo",
    "location": "Ubicación",
    "location_value": "Menorca, Islas Baleares, España",
    "resume": "Currículum",
    "openpdf": "Abrir PDF",
    "certifications": "Certificaciones",
    "contact_1": "Para oportunidades junior SOC / Blue Team, escríbeme:",
    "contact_2": "También puedes revisar mi <a href='https://github.com/JimBLogic' target='_blank' rel='noopener noreferrer'>GitHub</a>, <a href='./assets/pdfs/Jaime Ramsden de Frutos CV.pdf' target='_blank' rel='noopener noreferrer'>CV</a> o <a href='https://www.linkedin.com/in/jimblogic/' target='_blank' rel='noopener noreferrer'>LinkedIn</a>.",
    ...
    "proof_path_eyebrow": "Ruta para recruiters",
    "proof_path_title": "Una ruta de evidencia de 60 segundos",
    "proof_path_intro": "Empieza por lo que he construido, revisa cómo explico las decisiones y verifica después la formación que lo respalda.",
    "proof_path_1_title": "Ver el resultado",
    "proof_path_1_desc": "Abre el informe de inteligencia defensiva de hoy.",
    "proof_path_2_title": "Revisar el sistema",
    "proof_path_2_desc": "Examina la automatización y sus validaciones.",
    "proof_path_3_title": "Seguir el despliegue",
    "proof_path_3_desc": "Explora la base del homelab defensivo.",
    "proof_path_4_title": "Verificar fundamentos",
    "proof_path_4_desc": "Comprueba certificados y laboratorios seleccionados."
  },
  "ca": {
    "main_name": "Jaime Ramsden de Frutos",
    ...
    "hero_eyebrow": "Candidat a Analista SOC Junior / Blue Team · Menorca · Remot a Espanya / UE",
    "hero_statement": "Converteixo l'aprenentatge diari en evidència defensiva auditable. Construeixo sistemes de seguretat petits i inspeccionables que mostren com penso: triatge basat en fonts, operacions Linux i contenidors, visibilitat de xarxa, documentació, recuperació i automatització acurada.",
    ...
    "projects_intro": "Comença aquí per veure evidència útil en una entrevista. Aquests casos expliquen què s’ha construït, per què és rellevant per a la defensa i on hi ha codi o notes públiques disponibles.",
    "email": "Correu",
    "location": "Ubicació",
    "location_value": "Menorca, Illes Balears, Espanya",
    "resume": "Currículum",
    "openpdf": "Obrir PDF",
    "certifications": "Certificacions",
    "contact_1": "Per a oportunitats junior SOC / Blue Team, escriu-me:",
    "contact_2": "També pots revisar el meu <a href='https://github.com/JimBLogic' target='_blank' rel='noopener noreferrer'>GitHub</a>, <a href='./assets/pdfs/Jaime Ramsden de Frutos CV.pdf' target='_blank' rel='noopener noreferrer'>CV</a> o <a href='https://www.linkedin.com/in/jimblogic/' target='_blank' rel='noopener noreferrer'>LinkedIn</a>.",
    ...
    "proof_path_eyebrow": "Ruta per a recruiters",
    "proof_path_title": "Una ruta d'evidència de 60 segons",
    "proof_path_intro": "Comença pel que he construït, revisa com explico les decisions i verifica després la formació que ho sosté.",
    "proof_path_1_title": "Veure el resultat",
    "proof_path_1_desc": "Obre l'informe d'intel·ligència defensiva d'avui.",
    "proof_path_2_title": "Revisar el sistema",
    "proof_path_2_desc": "Examina l'automatització i les validacions.",
    "proof_path_3_title": "Seguir el desplegament",
    "proof_path_3_desc": "Explora la base de l'homelab defensiu.",
    "proof_path_4_title": "Verificar fonaments",
    "proof_path_4_desc": "Comprova certificats i laboratoris seleccionats."
  }
};
