...
const translations = {
  ...
  es: {
    ...
    title: "Analista de Ciberseguridad | Ethical Hacker | AWS Cloud Practitioner",
    email: "Correo",
    location: "Ubicación",
    ...
    passion_learning_desc: "La ciberseguridad está en constante evolución, y me apasiona mantenerme a la vanguardia. Desde competiciones capture-the-flag hasta la lectura de papers de investigación en seguridad, siempre estoy ampliando mis conocimientos y probando nuevas técnicas.",
    passion_learning_link: "Explora mi ruta de aprendizaje →",
    passion_community_title: "Comunidad y Colaboración",
    passion_community_desc: "Creo en compartir conocimiento y ayudar a otros a crecer. Ya sea documentando mi ruta de aprendizaje en GitHub o mentoreando a principiantes, estoy comprometido con construir una comunidad de seguridad más fuerte.",
    ...
    skills_5_desc: "Evaluación de vulnerabilidades, metodologías de ethical hacking, reconocimiento OSINT - Pensar como un atacante para fortalecer las defensas",
    ...
    edu_bootcamp_org: "UpgradeHub",
    edu_bootcamp_date: "2024",
    edu_bootcamp_desc: "Programa intensivo a tiempo completo que cubre ethical hacking, Cloud Security, Digital Forensics y respuesta a incidentes. Experiencia práctica con herramientas estándar de la industria y escenarios del mundo real.",
  ...
  ca: {
    main_name: "Jaime R. de Frutos",
    title: "Analista de Ciberseguretat | Ethical Hacker | AWS Cloud Practitioner",
    email: "Correu",
    location: "Ubicació",
    ...
    passion_learning_desc: "La ciberseguretat està en constant evolució, i m'apassiona mantenir-me al capdavant. Des de competicions capture-the-flag fins a la lectura de papers d'investigació en seguretat, sempre estic ampliant els meus coneixements i provant noves tècniques.",
    passion_learning_link: "Explora la meva ruta d'aprenentatge →",
    passion_community_title: "Comunitat i Col·laboració",
    passion_community_desc: "Crec en compartir coneixement i ajudar els altres a créixer. Sigui documentant la meva ruta d'aprenentatge a GitHub o mentorant principiants, estic compromès amb construir una comunitat de seguretat més forta.",
    ...
    about_btn_5: "OSINT",
    about_btn_6: "Bitcoin",
    about_p1: "Sóc un aspirant a analista junior de ciberseguretat amb formació pràctica en ethical hacking, Cloud Security i Digital Forensics. Recentment vaig completar un bootcamp intensiu a <a href='./assets/pdfs/UpgradeHub/UpgradeHub Cert.pdf' target='_blank'>UpgradeHub</a>, on vaig adquirir experiència real utilitzant Kali Linux, Metasploit, AWS, Splunk, Wireshark i més.",
    ...
    skills_5_desc: "Avaluació de vulnerabilitats, metodologies d'ethical hacking, reconeixement OSINT - Pensar com un atacant per enfortir les defenses",
    ...
    edu_bootcamp_org: "UpgradeHub",
    edu_bootcamp_date: "2024",
    edu_bootcamp_desc: "Programa intensiu a temps complet que cobreix ethical hacking, Cloud Security, Digital Forensics i resposta a incidents. Experiència pràctica amb eines estàndard de la indústria i escenaris del món real.",
